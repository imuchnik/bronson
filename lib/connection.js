...
(function() {
  ...
  Connection = (function() {
    ...
    Connection.prototype.broadcast = function(data) {
      ...
      sendToSelf = data.toSelf || this.bronson.sendToSelf;
      response = {};
      ...
      if (data.backendRequest != null) {
        ...
        return this.httpController.request({
          ...
          success: function(response) {
            ...
            return _this.room.broadcast(data.event, response, sendToSelf, _this);
          }
        });
      } else {
        return this.room.broadcast(data.event, response, sendToSelf, this);
      }
    };
